...
def compute_observables(data : dict) -> dict:
    """Computes extra observables needed for analyzing the nuclear polarization.

    Args:
        data (dict): Dictionary generated by load_data().

    Returns:
        dict: Dictionary including original data and computed observables.
    """
...
def generate_histograms(data : dict, cuts : dict, fname="./histograms.root") -> None:
    """Generate histograms of data before and after applying cuts.

    Args:
        data (dict): Data dictionary from load_data() after running compute_observables().
        cuts (dict): Dictionary specifying the cuts that are applied.
        fname (str, optional): Filename (including filepath) of output file. Defaults to "./histograms.root".
    """
